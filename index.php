...
<div class="col-md-6 alighinput d-flex">
                    ...
                    <input type="text" class="form-control autosave" id="date_consultation" name="date_consultation" style="min-width:16rem ; margin-right:10px"; >
                        
                    <label for="">Past history of present ailment if any :</label>
                    <input type="text" class="form-control autosave" id="past_history" name="past_history" style="min-width:16rem";>
                ...
                <div class="col-md-6 aligninput">
                    ...
                    <input type="text" class="form-control autosave" id="line_treatment" name="line_treatment" >
                </div>
                <div class="col-md-6 aligninput" >
                    <span class="alphabet">I.</span>
